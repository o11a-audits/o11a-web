...
let behaviors_promise;

export function set_behaviors_promise(promise) {
  behaviors_promise = promise;
}

export function get_behaviors_promise() {
  if (!behaviors_promise) {
    return Result$Error();
  }
  return Result$Ok(behaviors_promise);
}

let behaviors;

export function set_behaviors(val) {
  behaviors = val;
}

export function get_behaviors() {
  if (!behaviors) {
    return Result$Error();
  }
